 ...
 * @param The vector to add to this one */
  ...
  {
    return m_floats[0] <
           m_floats[1] ? (m_floats[0] < m_floats[2] ? 0 : 2) : (m_floats[1] < m_floats[2] ? 1 : 2);
  }
  ...
  {
    return m_floats[0] <
           m_floats[1] ? (m_floats[1] < m_floats[2] ? 2 : 1) : (m_floats[0] < m_floats[2] ? 2 : 0);
  }
...
public:
  ...
  TF2SIMD_FORCE_INLINE tf2Vector4(
    const tf2Scalar & x, const tf2Scalar & y, const tf2Scalar & z,
    const tf2Scalar & w)
  : Vector3(x, y, z)
  {
    m_floats[3] = w;
