...
#define TF2_DECLARE_ALIGNED_ALLOCATOR() \
  TF2SIMD_FORCE_INLINE void * operator new(size_t sizeInBytes) {return tf2AlignedAlloc(sizeInBytes, \
             16);} \
  ...
  TF2SIMD_FORCE_INLINE void * operator new[](size_t sizeInBytes) {return tf2AlignedAlloc( \
      sizeInBytes, 16);} \
  TF2SIMD_FORCE_INLINE void operator delete[](void * ptr) {tf2AlignedFree(ptr);} \
  TF2SIMD_FORCE_INLINE void * operator new[](size_t, void * ptr) {return ptr;} \
  TF2SIMD_FORCE_INLINE void operator delete[](void *, void *) {} \
...
TF2SIMD_FORCE_INLINE unsigned tf2Select(
  unsigned condition, unsigned valueIfConditionNonZero,
...
TF2SIMD_FORCE_INLINE int tf2Select(
  unsigned condition, int valueIfConditionNonZero,
...
TF2SIMD_FORCE_INLINE float tf2Select(
  unsigned condition, float valueIfConditionNonZero,
  float valueIfConditionZero)
{
#ifdef TF2_HAVE_NATIVE_FSEL
  return (float)tf2Fsel((tf2Scalar)condition - tf2Scalar(
